...
namespace PerformancePatterns.BufferedBuilder.Classic
{
    public class ClassicStoreRevenuePerProductRepository
    {

        public ClassicStoreRevenuePerProductRepository()
        {
        ...
        public string FormatAsXml() 
        {
            ...
            {
                xmlString  = xmlString + item.ToString();
            }

            xmlString = xmlString + "</StoreReveneuesPerProducts>";
